  ...
  return (
    <InView>
      {({ inView, ref }) => (
        <motion.div
          ref={ref}
          className={`bg-footerBack h-40 w-full ${inView ? "visible" : "invisible"}`}
          initial={{ opacity: 0 }}
        ...
        <div className=" flex gap-x-4 my-4 relative bottom-3 z-50 ">
          ...
          <a href="https://iq.linkedin.com/in/yusif-qasim-208473232?trk=people-guest_people_search-card" target="_blank">
            <Image
              src="/linkedwhite.svg"
              alt="Telegram logo"
              width={20}
          ...
          <a href="https://twitter.com/EusifQasim?t=XtH8suqlfeWm5c4Q3ci9kA&s=09" target="_blank">
            <Image
              src="/twiter.svg"
              alt="Telegram logo"
              width={20}
          ...
          <a href="https://www.facebook.com/YUSIF.QASIM.ALI?mibextid=ZbWKwL" target="_blank">
            <Image
              src="/facebook.svg"
              alt="Telegram logo"
              width={20}
          ...
          <a href="https://instagram.com/yusif_qasim_?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D" target="_blank">
            <Image
              src="/instagram.svg"
              alt="Telegram logo"
              width={20}
