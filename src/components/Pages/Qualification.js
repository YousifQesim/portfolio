...
export default function Qualification() {
  ...
  const [showCertificationTimeline, setShowCertificationTimeline] =
    useState(false);
          ...
          <ul className="flex justify-center my-16 text-sm md:text-lg">
            <li>
              ...
              >
                <Image
                  className={`${
                    activeButton === "education" ? "inline" : "hidden"
                  }`}
                ...
                <Image
                  className={`${
                    activeButton === "education" ? "hidden" : "inline"
                  }`}
                  src="/education.svg"
                  alt="education logo - Yusif Qasim"
                  width={20}
            ...
            <li>
              ...
              >
                <Image
                  className={`${
                    activeButton === "certification" ? "inline" : "hidden"
                  }`}
                ...
                <Image
                  className={`${
                    activeButton === "certification" ? "hidden" : "inline"
                  }`}
            ...
            <li>
              <motion.button
                ...
                className={`mb-4 py-2 px-4 flex gap-1 items-center ${
                  activeButton === "work" ? "text-violet-600" : "text-white"
                }`}
              >
                <Image
